...
1x arms: data/runs/nglab1x_opt_* (seed 42) + nglab1x_v10_input_fixed as RMSProp 1x.
2x arms: data/runs/nglab2x_opt_* + nglab2x_input_v10_fv_fixed as RMSProp 1x.
Writes docs/figs_v10/fig_table_opt_1x_vs_2x.{svg,png}.
"""
import json
import os
import numpy as np
