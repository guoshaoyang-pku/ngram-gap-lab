...
## Table-size axis
- bigram: log-log slope `0.040988`, R² `0.977575`, rank correlation `0.991744`, n=`18`; K=`3541098`, and K/R is a load ratio only. Collision rate was not measured.
- trigram: log-log slope `0.246642`, R² `0.981815`, rank correlation `1.000000`, n=`18`; K=`19027841`, and K/R is a load ratio only. Collision rate was not measured.

## Epoch-length axis
- Quadratic descriptive fit in ln(L4 multiplier): vertex `0.474733×L4`, predicted gap `3.029724`, R² `0.743451`; this summarizes the observed U-shape and is not a mechanistic law.
