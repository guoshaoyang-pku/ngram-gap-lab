#!/usr/bin/env bash
# Stage 3R random-first-epoch strict checkpoint fork.
# Usage:
#   run_reshuffle_stage3r_random_fork.sh GPU prefix RUN_ID
#   run_reshuffle_stage3r_random_fork.sh GPU frozen RUN_ID CHECKPOINT
#   run_reshuffle_stage3r_random_fork.sh GPU reshuffle RUN_ID CHECKPOINT
set -euo pipefail

GPU=${1:?GPU index required}
PHASE=${2:?phase required: prefix|frozen|reshuffle}
